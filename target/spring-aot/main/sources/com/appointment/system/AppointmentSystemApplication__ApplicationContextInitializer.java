 ...
 */
@Generated
public class AppointmentSystemApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new AppointmentSystemApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new AppointmentSystemApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
